        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="register-xuly.php" method="POST">
                            <div class="mb-3">
                                <label for="full_name" class="form-label">Full Name</label>
                                <input type="text" id="full_name" name="full_name" class="form-control" value="<?php echo isset($old['full_name']) ? htmlspecialchars($old['full_name']) : ''; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="address" name="address" class="form-control" value="<?php echo isset($old['address']) ? htmlspecialchars($old['address']) : ''; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="phone" name="phone" class="form-control" value="<?php echo isset($old['phone']) ? htmlspecialchars($old['phone']) : ''; ?>">
