...
include 'header.php';
include 'detail-xuly.php'; // Lấy thông tin chi tiết sản phẩm

// Kiểm tra nếu người dùng chưa đăng nhập
if (!isset($_SESSION['user'])) {
    // Lưu URL hiện tại vào session để chuyển hướng lại sau khi đăng nhập
            ...
            <div class="h-100 bg-light p-30">
                ...
                <div class="mb-4">
                    ...
                    <?php if (!empty($product_size)): ?>
                        <form method="POST" action="cart-xuly.php"> <!-- Form gửi size và ID sản phẩm -->
                            <?php 
                            ...
                            <?php else: ?>
                                <a href="login.php" class="btn btn-primary px-3 mt-3"><i class="fa fa-user mr-1"></i> Login to add to cart</a>
                            <?php endif; ?>
                        </form>
                    <?php else: ?>
                ...
                <!-- Thông tin bổ sung -->
                <p>Stock: <?php echo htmlspecialchars($product_stock); ?> items available</p>
                <p>Created at: <?php echo htmlspecialchars($product_created_at); ?></p>
            </div>
        </div>
    </div>
</div>
