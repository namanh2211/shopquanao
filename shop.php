<?php 
include 'header.php';
include 'shop-xuly.php'; // Include file để lấy danh sách sản phẩm từ cơ sở dữ liệu
?>
                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            <?php if ($current_page > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="shop.php?page=<?php echo $current_page - 1; ?>">Previous</a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if ($current_page < $total_pages): ?>
                                <li class="page-item">
                                    <a class="page-link" href="shop.php?page=<?php echo $current_page + 1; ?>">Next</a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </nav>
